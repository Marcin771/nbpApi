...
public class NbpExchangeRateDownloader {
    ...
    public NbpExchangeRateResult download(LocalDate forDate, Currency currency) {
    ...
    private Map<String, String> prepareUrlParams(LocalDate forDate, Currency currency) {
